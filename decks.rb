...
class BootcampData
	def initialize
		...
		@bootcamp.add_person("Phil Esterman", "photos/phil_esterman.jpg", "Branford 2017")
		...
		@bootcamp.add_person("Joe Calamia", "photos/Joseph_Cala.jpg", "Forestry 2015")
		...
		@bootcamp.add_person("Charlie Proctor", "photos/charlie_proctor.jpg", "TD 2017")
